      ...
      <div className="hidden md:block bg-gradient-to-r from-blue-900 via-blue-700 via-cyan-400 via-teal-400 to-emerald-400 text-white">
        <div className="h-[40px] max-w-7xl mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-center h-full">
            <div className="flex items-center justify-center md:gap-[100px] lg:gap-[400px] md:mr-24! lg:mr-48!">
              ...
              <div className="flex gap-4 items-center md:gap-2 lg:gap-4">
                <div className="flex gap-1 items-center">
                  <a href="mailto:info@ASTA.EDU.SA" target="_blank" className="md:text-sm lg:text-[16px] hover:opacity-80 transition-opacity">
                    INFO@ASTA.EDU.SA
                  </a>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="md:w-3 md:h-3 lg:w-[14px] lg:h-[14px]">
                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                </div>
                <div className="flex gap-1 items-center">
                  <a href="https://wa.me/+996558919492" target="_blank" className="md:text-sm lg:text-[16px] hover:opacity-80 transition-opacity">
                    +996-55 8919492
                  </a>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="md:w-3 md:h-3 lg:w-[14px] lg:h-[14px]">
      ...
      <div className="bg-white lg:mt-8!">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="hidden md:flex items-center justify-between py-3 p-4!">
            ...
            <div className="flex items-center gap-4 md:gap-2 lg:gap-4">
              ...
              <div className="flex items-center gap-1 cursor-pointer">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-blue-900 md:w-4 md:h-4 lg:w-[18px] lg:h-[18px]">
                  <circle cx="12" cy="12" r="10"/>
                  <line x1="2" y1="12" x2="22" y2="12"/>
                  <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
                </svg>
                <span className="text-base font-medium text-[#202C5B] md:text-sm lg:text-base">English</span>
              </div>
              ...
              <div className="relative">
                <a
                  href="#"
                  className="px-3! py-2! md:text-sm lg:text-xlg font-medium rounded-full text-white bg-gradient-to-r from-cyan-500 to-emerald-400 hover:opacity-90 transition-opacity whitespace-nowrap md:px-2! md:py-1! lg:px-3! lg:py-2!"
                >
                  فحص شهادة
                </a>
                <svg 
                  className="absolute lg:text-3xl left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#202C5B] md:w-3 md:h-3 lg:w-4 lg:h-4"
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <input
                  ...
                  className="w-72! mr-5! md:w-40! lg:w-72! md:text-sm lg:text-xl px-3! py-1! md:px-2! md:py-0.5! lg:px-3! lg:py-1! placeholder:text-gray-400 text-gradient-to-r from-cyan-500 to-emerald-400 border-1 border-gradient-to-r from-cyan-500 to-emerald-400 rounded-full pr-10 focus:outline-none focus:border-cyan-500 transition-colors"
                  dir="rtl"
                />
              </div>
            </div>
          ...
          <div className="md:hidden">
            {/* Mobile Semi Header */}
            <div className="h-[40px]  bg-gradient-to-r from-blue-900 via-blue-700 via-cyan-400 via-teal-400 to-emerald-400"></div>
            ...
            <div className="py-2! px-6!">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  {/* Mobile search icon */}
                  <svg className="w-6 h-6 font-medium text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
          ...
          <div className="hidden md:flex justify-center items-center py-3 border-gray-200">
            <div className="flex items-center gap-4 p-3 mb-4! md:gap-2 lg:gap-4">
              <a 
                href="#" 
                className="md:text-lg lg:text-[24px] px-6 py-1 pl-[12px]! text-cyan-500 font-medium border-l-2 border-blue-900 hover:text-cyan-600 transition-colors"
              >
                الدورات
              </a>
              <a 
                href="#" 
                className="md:text-lg lg:text-[24px] px-6 py-1 pl-[12px]! text-blue-900 font-medium border-l-2 border-blue-900 hover:text-cyan-500 transition-colors"
              >
                المسارات
              </a>
              ...
              <div className="relative" ref={trainersRef}>
                <button
                  ...
                  className="flex items-center cursor-pointer gap-1 md:text-lg lg:text-[24px] pl-[12px]! py-1 text-blue-900 font-medium border-l-2 border-blue-900 hover:text-cyan-500 transition-colors"
                >
                  المدربين
                ...
                {trainersDropdown && (
                  <div className="absolute top-full right-0 mt-1 w-44 bg-white rounded-lg shadow-lg border z-50">
                    <div className="py-1">
                      <a href="#" className="block px-4 py-2 md:text-sm lg:text-xlg text-blue-900 hover:bg-gray-50 hover:text-cyan-500 transition-colors">
                        جميع المدربين
                      </a>
                      <a href="#" className="block px-4 py-2 md:text-sm lg:text-xlg text-blue-900 hover:bg-gray-50 hover:text-cyan-500 transition-colors">
                        المدربين المعتمدين
              ...
              <div className="relative" ref={aboutRef}>
                ...
                {aboutDropdown && (
                  <div className="absolute top-full right-0 mt-1 w-44 bg-white rounded-lg shadow-lg border z-50">
                    <div className="py-1">
                      <a href="#" className="block px-4 py-2 md:text-sm lg:text-lg text-blue-900 hover:bg-gray-50 hover:text-cyan-500 transition-colors">
                        عن الأكاديمية
                      </a>
                      <a href="#" className="block px-4 py-2 md:text-sm lg:text-lg text-blue-900 hover:bg-gray-50 hover:text-cyan-500 transition-colors">
                        رؤيتنا ورسالتنا
